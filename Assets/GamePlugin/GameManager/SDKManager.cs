...
namespace mygame.sdk
{
    ...
    public class SDKManager : MonoBehaviour
    {
        ...
        public string AdFlyAdapterVersion = "0.14.3.0";
#endif
        ...
        private void Start()
        {
            ...
            if (isShowSplashLoading)
            {
                // if (isShowSplash())
                {
                    ...
                    splashLoadingCtr.showLoading(4);
#else
                    splashLoadingCtr.showLoading(5);
#endif
                }
            }
            else
            ...
            //deviceIsRooted = GameHelper.deviceIsRooted();
        }
        ...
        {
            string memlv = PlayerPrefs.GetString("mem_lv_showrate", ",5,10,30,35,40,");
            if (memlv.Length > 0)
            {
                if (!memlv.StartsWith(","))
                {
