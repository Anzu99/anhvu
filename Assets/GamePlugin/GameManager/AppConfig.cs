...
{
#if UNITY_ANDROID
    public const int gameID = 1041;
    public const int verapp = 11;
    public const string appid = "com.xgame.supermusk.adventure";
    ...
    public const string urlLogEvent = "http://supermusk.club/api";
    ...
    public const string defaultExcluseFull = "";
    ...
    public const bool isOnlyDefault = false;
    public const bool isBannerIpad = false;
    public const string defaultStepBanner = "cir:6#re:11,0";//cir:1,0#re:3,2
    public const string defaultStepFull = "cir:6#re:11,0,10";//cir:1,0#re:3,2
    public const string defaultExcluseFull = "";
    public const string defaultStepGift = "cir:6#re:11,0";//cir:1,0#re:3,2
    public const bool isAddAdsMob = false;

    public const long TimeSubmitReview = 1647257668;
    ...
    public const string defaultExcluseFull = "3,6";
